...
<body>
    ...
    <section id="header">
        ...
        <div id="menu">
            <form class="search" role="search" method='POST' action='search.php'>
    ...
    $search = strtolower($_POST["data"]);
    $s = "select id from products where name = '$search'";
    $up = mysqli_query($con,$s);
    $b = mysqli_num_rows($up);
    if($b == 4 && $search == "tiles" ){
        echo
        ...
        <img src="../img/tiles/kajaria.jpg" alt="kajaria tiles">
            <div class="des">
                <span>Kajaria</span>
                <h5 class="card-title">kajaria Tiles No.1</h5>
                <div class="star">
            ...
            <input type="hidden" name="item" value="kajaria Tiles No.1">
        ...
        <form  method="post" action="add.php">
            ...
            <button type="submit" name="cart" class="cart"><i class="fal fa-shopping-cart cart"></i></button>
            <input type="hidden" name="item" value="AGL Tiles No.2">
        ...
        <form  method="post" action="add.php">
            ...
            <button type="submit" name="cart" class="cart"><i class="fal fa-shopping-cart cart"></i></button>
            <input type="hidden" name="item" value="BAJAJ Tiles  No.3">
    ...
    elseif($b == 4 && $search == "plywood"){
        ...
        echo "product registered successfully coming soon!!!";
    }
    ?>
    </body>
